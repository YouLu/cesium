...
define([
    ...
    var SelectionIndicatorViewModel = function(scene, selectionIndicatorElement, container) {
        ...
        knockout.track(this, ['_position', '_positionX', '_positionY', 'triangleDistance', 'triangleRotation', '_showSelection', '_titleText', '_descriptionHtml', 'maxHeight', 'enableCamera', 'isCameraTracking']);
